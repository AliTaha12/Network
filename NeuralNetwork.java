...
public class NeuralNetwork implements Serializable{
  ...
  public double[] E_O(double[] expected){
    ...
    for(int i=0;i<tbr.length;i++){
      tbr[i]=(sigmoidSmallTable[smallTable.length-1][i]-expected[i])*dsigmoid(smallTable[smallTable.length-1][i]);
    }
    return tbr;
  }
  ...
  public static double[][] read(int lines) throws FileNotFoundException{
    ...
    Scanner scanner = new Scanner(new File("mnist_train.csv"));
  ...
  public static double[][] read3(int lines) throws FileNotFoundException{
    double[][]tbr=new double[lines][785];
  ...
  public void test(int n) throws FileNotFoundException{
    ...
    System.out.println("percent correct is " + number/10000.);
  }
...
*/
  ...
  public static void main(String[] args) throws FileNotFoundException,IOException,  ClassNotFoundException{
    NeuralNetwork popsy3= dakhal("popsy9.txt");
    double[][] trainingdata = read(60000);
    System.out.println("Done Reading");
    for(int i=0;i<10000;i++){
    for(int epoch=0;epoch<60000;epoch++){
      popsy3.train(Arrays.copyOfRange(trainingdata[epoch],1,785),createoutput(trainingdata[epoch][0]),0.000001);
    }
    popsy3.save("popsy9.txt");System.out.println(i);}
